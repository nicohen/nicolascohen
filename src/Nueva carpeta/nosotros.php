...
<table border="0" cellpadding="0" cellspacing="0">
	<tr valign="top">
		<td>
			<table border="0" cellpadding="0" cellspacing="0">
				<tr><td><img src="<?php echo NOSOTROS?>h_acerca_nos_1.jpg" /></td></tr>
				<tr><td><img src="<?php echo NOSOTROS?>h_acerca_nos_2.jpg" /></td></tr>
								...
								<div id="div_externo" STYLE="overflow:hidden;position:relative; top:20px; left:30px; width:430px; height:280px;"> 
				                    <div STYLE="position:relative;">
										<font class="contenido"> 
											<?php $hand=fopen(TEXT.$language."_nosotros.txt",READ) or die("<center>[No hay texto cargado]</center>");
													  leer_archivo($hand);
													  cerrar_archivo($hand);
											?>
                      					</font>
		...
		<td>
			<table border="0" cellpadding="0" cellspacing="0">
				<tr><td><img src="<?php echo cargar_imagen(NOSOTROS,$language,'t_acerca_nos.jpg') ?>" /></td></tr>
				<tr><td><img src="<?php echo NOSOTROS ?>f_acerca_nos.jpg" /></td></tr>
			</table>
		</td>
	</tr>
</table>